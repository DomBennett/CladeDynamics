...
# This is a new script that should replace clade.R if necessary
...
check <- function (outfile) {
  ...
  cladesi.file <- file.path (wd, paste0 (outfile, '_clades_ind.csv'))
  clade.stats.file <- file.path (wd, paste0 (outfile, '_clade_stats.csv'))
  cladei.stats.file <- file.path (wd, paste0 (outfile, '_clade_ind_stats.csv'))
  trees.file <- file.path (wd, paste0 (outfile, '_recorded.rda'))
